...
- Si la cantidad recargada excede el máximo deberá retornarse la cadena “Se recargó la lapicera y sobró __ cantidad de tinta. (Rellenar el espacio con el valor que se haya excedido)
...
boligrafo_azul = Boligrafo(0.5,"Azul")
boligrafo_rojo = Boligrafo(1.4,"Rojo")

print(boligrafo_azul.escribir("Hola"*40))
print(boligrafo_azul.recargar(110))
print(boligrafo_azul.escribir("Hola"))

print(boligrafo_rojo.escribir("HOLA"*20))
print(boligrafo_rojo.recargar(20))
print(boligrafo_azul.escribir("HOLA"))
